...
class __TwigTemplate_16e6c557d108d984c3f00553bdd3899adab771cad7aaee754deff38acd8c3f13 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Language");
        // line 9
        echo "      ";
        echo (((0 !== twig_compare(_gettext("Language"), "Language"))) ? (" - Language") : (""));
        echo "
    </label>
  </bdo>
  <br>
...
echo _gettext("Servers");
  ...
  <div class=\"form\">
    ";
        // line 45
        if ((1 === twig_compare(($context["server_count"] ?? null), 0))) {
            // line 46
...
echo _gettext("Default server");
      ...
      <td>
        ...
        if ((1 === twig_compare(($context["server_count"] ?? null), 0))) {
            // line 138
            echo "            ";
            if ((1 === twig_compare(($context["server_count"] ?? null), 1))) {
                // line 139
                echo "              <option value=\"0\">";
echo _gettext("let the user choose");
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["server"]) {
                ...
                echo "\"";
                echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["server"], "id", [], "any", false, false, false, 143), 1))) ? (" selected") : (""));
                echo ">";
...
echo _gettext("End of line");
      ...
      <td>
        <select name=\"eol\" id=\"eol\" class=\"w-75\">
          <option value=\"unix\"";
        // line 156
        echo (((0 === twig_compare(($context["eol"] ?? null), "unix"))) ? (" selected") : (""));
        echo ">UNIX / Linux (\\n)</option>
          <option value=\"win\"";
        // line 157
        echo (((0 === twig_compare(($context["eol"] ?? null), "win"))) ? (" selected") : (""));
        echo ">Windows (\\r\\n)</option>
        </select>
      </td>
    </tr>
...
";
    ...
    {
        return new Source("", "setup/home/index.twig", "C:\\Users\\Hadi Majid\\Desktop\\phpMyAdmin-5.2.0-all-languages\\templates\\setup\\home\\index.twig");
    }
}
