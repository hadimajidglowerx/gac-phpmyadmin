...
/* setup/base.twig */
class __TwigTemplate_0df94ff6ba47d6847d3d937ad8b79eac785cc9340c0d7d4687877359bb7dbe96 extends Template
{
    private $source;
    private $macros = [];
...
$context["page"], "formset", [], "any", false, false, false, 36)]);
            // line 37
            echo "\"";
            echo (((0 === twig_compare(($context["formset"] ?? null), twig_get_attribute($this->env, $this->source, $context["page"], "formset", [], "any", false, false, false, 37)))) ? (" class=\"active\"") : (""));
            echo ">
          ";
            // line 38
...
";
    ...
    {
        return new Source("", "setup/base.twig", "C:\\Users\\Hadi Majid\\Desktop\\phpMyAdmin-5.2.0-all-languages\\templates\\setup\\base.twig");
    }
}
